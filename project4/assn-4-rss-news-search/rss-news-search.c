...
static const char *const kWelcomeTextFile = "/home/pb/Desktop/workspace/Programming_paradigms/project4/data/welcome.txt";
static const char *const kDefaultFeedsFile = "/home/pb/Desktop/workspace/Programming_paradigms/project4/data/rss-feeds.txt";
 ...
 * ------------------------
 * Works more or less like G/etNextTag below, but this time
...
static void ProcessSingleNewsItem(streamtokenizer *st)
{
  ...
  /* if (strncmp(articleTitle, "", sizeof(articleTitle)) != 0){ */
      /* printf("Article Title: %s.\n", articleTitle); */
      /* printf("Article Descrtiption: %s.\n", articleDescription); */
...
static void ExtractElement(streamtokenizer *st, const char *htmlTag, char dataBuffer[], int bufferLength)
{
  ...
  /* printf("Descripting after extracting: %s.\n", dataBuffer); */
  if (dataBuffer[0] == '<'){ 
      /* printf("ya the description is empty.\n"); */
