...
static const char *const kWelcomeTextURL = "/home/pb/Desktop/workspace/Programming_paradigms/project4/data/welcome.txt";
static const char *const kDefaultStopWordsURL = "/home/pb/Desktop/workspace/Programming_paradigms/project4/data/stop-words.txt";
static const char *const kDefaultFeedsFileURL = "/home/pb/Desktop/workspace/Programming_paradigms/project4/data/rss-feeds.txt";
...
{
    FILE* fData;
    fData = fopen(welcomeTextURL, "r");

    streamtokenizer st;
    char buffer[4096];
    STNew(&st, fData, kNewLineDelimiters, true);
...
static void ProcessFeed(const char *remoteDocumentURL)
{
  ...
  urlconnection urlconn;
    ...
    /* printf("This is the userData struct.\n"); */
    /* printf("Title: %s.\n", item->title); */
...
static void ProcessStartTag(void *userData, const char *name, const char **atts)
{
  ...
  if (strcasecmp(name, "item") == 0) {
    memset(item, 0, sizeof(rssFeedItem));
      ...
      /* This will set the activeField to item->title which is a char[] and
