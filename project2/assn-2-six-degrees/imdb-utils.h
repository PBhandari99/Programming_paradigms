...
inline const char *determinePathToData(const char *userSelectedPath = NULL)
{
  ...
  return "/home/pb/Desktop/workspace/Programming_paradigms/project2/assn-2-six-degrees-data/little-endian/";
  // if (strcasecmp(ostype, "solaris") == 0)
    // return "/home/pb/Desktop/workspace/Programming_paradigms/project2/assn-2-six-degrees-data/big-endian/";
